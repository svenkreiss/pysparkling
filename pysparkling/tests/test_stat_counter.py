...
# todo: replace col with a method that convert an expression into a Column
#  that correspond to one SQL Row field
def col(x):
    return x
...
if __name__ == '__main__':
    test_mean()
    # pylint: disable=fixme
    # todo: activate this test when pysparkling.sql is implemented
