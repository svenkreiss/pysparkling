...
class Column(object):
    ...
    def when(self, condition, value):
        ...
        if self.expr.default is not None:
            raise IllegalArgumentException("when() cannot be applied once otherwise() is applied")

        return Column(self.expr.with_when(parse(condition), parse(value)))
    ...
    def otherwise(self, value):
        ...
        return Column(self.expr.with_otherwise(parse(value)))
